...
class MozosController //implements IController
{
  ...
  public static function ActualizarEstadoPedido($orden)
  {
    ...
    if($pedidoComida['estado']==$estadoListo&&$pedidoBebida['estado']==$estadoListo&&
